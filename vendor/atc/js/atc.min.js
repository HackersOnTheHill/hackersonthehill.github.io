      ...
      if (a && n)
        if ("block" == addeventatc.getstyle(n, "display")) addeventatc.hideandreset();
          ...
          var l = parseInt(a.offsetHeight),
            ...
            w = parseInt(f.x),
            b = (parseInt(f.y), addeventatc.elementposition(a)),
            x = (b.x, w + p),
            k = v + g,
            y = 0,
            _ = 0,
